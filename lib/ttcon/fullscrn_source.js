...
dojo.declare("ttcon.fullscrn", null,{
	...
	setImage: function(/*String*/ image){
		...
		// targetNode: Object
		// 			used for determining the subject of operations
		// animOut: Object
		...
		if(dojo.isString(image)){
			...
			var animOut = dojo.fadeOut({ node: this.imageNode });
			...
			dojo.connect(animOut, "onEnd", this, function(event){
				...
				if(this.isCssCapable){
					...
					targetNode = tempImage;
				}else{
					dojo.destroy(this.imageNode);
